...
// Utilities
import { Async } from "@uifabric/utilities/lib-commonjs/Async";
import { EventGroup } from "@uifabric/utilities/lib-commonjs/EventGroup";
import { IDisposable } from "@uifabric/utilities/lib-commonjs/IDisposable";
...
export abstract class BaseComponent<P, S> extends React.Component<P, S> {
     ...
     */
    protected resolveRef<T, K extends keyof T>(obj: T, refName: K): (ref: any) => any {
        if (!this._resolves) {
            this._resolves = {};
        }
