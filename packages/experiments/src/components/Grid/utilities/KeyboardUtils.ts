...
export namespace KeyboardUtils {
     ...
     */
    export function keyCodeIsSelectionKey(keyCode: KeyCode, keycodeMapper?: (keyCode: number) => number) {
     ...
     */
    export function executeWhenAllowedKeyPressed(
        allowedKeyCodes: KeyCode[],
        action: (...args: any[]) => void
    ): (ev: React.KeyboardEvent<HTMLElement>, ...args: any[]) => boolean {
        return (ev: React.KeyboardEvent<HTMLElement>, ...args: any[]): boolean => {
