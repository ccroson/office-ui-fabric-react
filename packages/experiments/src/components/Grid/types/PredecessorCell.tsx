...
export class PredecessorCell implements ICellType {
  ...
  public render(cellData: PredecessorCellData, context: CellContext): string {
    ...
    return cellData.predecessors
      ? cellData.predecessors
          .map((predecessor: ITag) => {
  ...
  public renderEditor(
    ...
    return (
      <PredecessorEditor
        ...
        onFetchPredecessorSuggestions={(searchString: string) =>
          this.onFetchPredecessorSuggestions(cellData.taskId, searchString)
        }
