...
export class MomentCalendarCell implements ICellType {
  ...
  public renderEditor(
    ...
    return (
      ...
      <DateEditor
        dateFormat={
          this.calendarFormat && typeof this.calendarFormat.sameElse === 'string'
            ? this.calendarFormat.sameElse
            : undefined
        }
  ...
  public parseRawInput(originalValue: moment.Moment, changedValue: any): moment.Moment {
    ...
    if (changedValue && moment.isMoment(changedValue)) {
      ...
      let validFormats = [moment.ISO_8601, DateFormat.GridDate, DateFormat.FullDigitDateFormat];
