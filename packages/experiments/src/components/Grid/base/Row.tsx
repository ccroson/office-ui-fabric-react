...
export class Row extends BaseComponent<IRowProps, {}> {
    ...
    private renderCells(): JSX.Element[] {
        ...
        for (let colIndex: number = 0; colIndex < numColumns; colIndex++) {
            ...
            let isEditing: boolean = selectionState &&
            ...
            if (cellRowSpan > 0) {
                ...
                const fillPosition: CellRegionPosition = (selectionState.fillSelection && selectionState.fillSelection.isCellInRegion(cellCoordinate)) ? selectionState.fillSelection.getCellPosition(cellCoordinate, cellRowSpan) : null;
                let selectionPosition: CellRegionPosition = GridUtilities.getCellRegionPositionIfSelected(cellCoordinate, selectionState.selections, cellRowSpan);
