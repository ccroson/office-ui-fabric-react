...
import { css, getRTL } from '../../../Utilities';
    ...
    if (isFixed) {
      ...
      return (
        ...
        >
          ...
          <div
            className="grid-header-placeholder grid-header-placeholder--fixed"
      ...
      return (
        <div className="grid-header-container" style={{ height: height }} role={GridConstants.ROWGROUP_ROLE}>
          <div className={css('grid-header', className)}>{children}</div>
          <div className="grid-header-placeholder" ref={this.resolveRef(this, 'headerPlaceHolderRef')} />
        </div>
      );
    }
  }
