...
export class Cell extends BaseComponent<ICellProps, {}> {
    ...
    protected renderComponent(): JSX.Element {
        ...
        const borderClassNameMapping: CellClassMapping = this.getBorderClassName(fillPosition, selectionPosition, editing, isPrimary, selectable);
    ...
    private getCellStyle(rowSpan: number, height: number, width: number, theme: GridTheme, cellClassMapping: CellClassMapping): React.CSSProperties {
        ...
        if (rowSpan !== 0) {
            if (cellClassMapping.editing) {
                ...
                RtlUtils.setRTLSafeBorderLeft(style, null, null, cellClassMapping.selectionEdgeLeft ? theme.selectionBorderColor : theme.borderColor);

                RtlUtils.setRTLSafeBorderRight(style, null, null, cellClassMapping.selectionEdgeRight ? theme.selectionBorderColor : theme.borderColor);
