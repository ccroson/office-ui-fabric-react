 ...
 */
export class __InlineAutoCompleteBox extends React.PureComponent<
  IInlineAutoCompleteBoxProps,
  IInlineAutoCompleteBoxState
> {
  ...
  public render(): JSX.Element {
    let { suggestedValue = '', value = '' } = this.props;
    return (
