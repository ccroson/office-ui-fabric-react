...
import { FocusZone, FocusZoneDirection } from 'office-ui-fabric-react/lib/components/FocusZone/index';
import { IconButton } from 'office-ui-fabric-react/lib/components/Button/index';
import { Persona } from 'office-ui-fabric-react/lib/components/Persona/index';
import { IPersonaProps, PersonaInitialsColor, PersonaSize } from 'office-ui-fabric-react/lib/components/Persona/index';
  ...
  private renderResource = (resource: Identifiable<IPersonaProps>, resourceIndex: number) => {
    ...
    return (
      <div key={resource.id || resourceIndex} className="resource-list-result">
        <button
          title={resource.primaryText}
          aria-label={`${resource.primaryText} ${resourceAriaLabel}`}
          className="resource-list-persona"
          {...buttonProps}
        >
          <Persona
            aria-label={resource.primaryText}
            key={resource.id}
